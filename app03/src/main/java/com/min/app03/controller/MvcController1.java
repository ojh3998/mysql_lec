...
public class MvcController1 {
   ...
   *   3) value={"/list", "/list.do"} : 2개 이상의 요청을 의미합니다. http://127.0.0.1:8080/app03/list,  http://127.0.0.1:8080/app03/list.do
   * 
   * 3. 요청 메소드 (method) 
  ...
  public String welcome() {
     ...
     * 4. ViewResolver 는 완성된 최종 View 로 이동합니다. (최종 View 의 모습 : "/WEB-INF/views/webdir1/index.jsp")
     */
  }
